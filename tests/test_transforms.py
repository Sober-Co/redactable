...
from redactable.policy.engine import _redact, _mask, _tokenize, _MaskCfg
...
def test_redact_single_finding():
    ...
    findings = [
        Finding(kind="email", value="alice@example.com", span=(12, 30), confidence=0.95)
    ]
...
def test_mask_with_keep_head():
    ...
    findings = [
        Finding(kind="ssn", value="078-05-1120", span=(5, 16), confidence=0.99)
    ]
...
def test_mask_custom_glyph():
    ...
    findings = [
        Finding(kind="phone", value="+447911123456", span=(7, 20), confidence=0.95)
    ]
